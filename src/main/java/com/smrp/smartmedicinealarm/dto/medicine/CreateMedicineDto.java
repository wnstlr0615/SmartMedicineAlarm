...
public class CreateMedicineDto {
    ...
    public static CreateMedicineDto createMedicineDto(Long itemSeq, String  itemName, String itemImage, String etcOtcName,
        ...
        Assert.hasText(itemImage, "itemName must not blank");
        Assert.hasText(etcOtcName, "itemName must not blank");
        Assert.hasText(classNoAndName.getClassNo(), "classNo must not blank");
        Assert.hasText(classNoAndName.getClassName(), "className must not blank");
        Assert.hasText(lengAndThick.getLengLong(), "LengLong must not blank");
        Assert.hasText(lengAndThick.getLengShort(), "LengShort must not blank");
        Assert.hasText(lengAndThick.getThick(), "LengThick must not blank");
        Assert.notNull(medicineCompany.getEntpSeq(), "entpSeq must not null");
        Assert.hasText(medicineCompany.getEntpName(), "entpName must not blank");
        Assert.hasText(medicineIdentification.getDrugShape(), "drugShape must not blank");
        Assert.hasText(medicineIdentification.getChart(), "chart must not blank");
